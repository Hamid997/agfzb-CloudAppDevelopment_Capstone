...
def get_request(url, **kwargs):
    ...
    try:
        if apikey:
            ...
            response = requests.get(url, data=params, headers={'Content-Type': 'application/json'}, auth=HTTPBasicAuth('apikey', apikey),)
        else:
...
def analyze_review_sentiments(dealer_review):
    apikey = "E_0hoYFgPit6DRsA_F5zF8FKnRYSKG5HWyqY2iSkM0If"
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/0954186b-3478-4fe7-875c-8c8d8f3f5bb5"
